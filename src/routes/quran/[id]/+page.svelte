            ...
            <div class="mt-2 p-5 rounded-2xl bg-emerald-500/[0.02] border border-emerald-500/10 space-y-3 animate-slide-up">
              <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-white/10">
                <div class="flex flex-wrap items-center gap-5">
                  <span class="text-lg sm:text-xl md:text-2xl font-black tracking-wider text-emerald-400 uppercase">Tafsir Ibnu Katsir</span>
                  <!-- Size adjustment buttons -->
                  <div class="flex items-center gap-3">
                    <span class="text-sm sm:text-base font-bold text-zinc-100">Ukuran Huruf:</span>
                    <div class="flex items-center gap-1.5 bg-white/5 rounded-2xl p-1.5 border border-white/10 shadow-inner">
                      <button 
                        onclick={() => $settings.tafsirFontSize = Math.max(12, ($settings.tafsirFontSize || 14) - 1)}
                        class="w-12 h-12 flex items-center justify-center text-base font-black text-zinc-100 hover:text-white hover:bg-white/20 rounded-xl transition-all active:scale-90 cursor-pointer"
                        title="Perkecil teks tafsir (A-)"
                      >
                        A-
                      </button>
                      <span class="text-base font-black text-emerald-400 px-4 min-w-[3rem] text-center bg-zinc-950/60 rounded-xl py-2 border border-white/10">
                ...
                <button 
                  ...
                  class="text-xs sm:text-sm md:text-base font-extrabold text-white bg-emerald-600 hover:bg-emerald-500 px-5 py-3.5 rounded-2xl active:scale-95 transition-all shadow-md cursor-pointer self-start lg:self-auto border border-emerald-500/25"
                >
                  Tutup Tafsir
                </button>
              </div>
